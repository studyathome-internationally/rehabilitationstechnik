...
> “The Disabled” denotes persons in all age groups who, as a result of a congenital or acquired health defect, are impaired in the performance of the usual age corresponding functions of life [@brockhaus:1994].

<!-- FIXME: not an actual “verbatim” quote -->

The substantive form “the disabled” is generally rejected as discriminatory and should generally be replaced by expressions such as “disabled people”, “persons with disabilities”, “disabled users” etc.
...
Society defines a certain “normality” and thus sets a threshold on a one-dimensional scale below which a person is considered disabled.
...
Thus, the substantive form “the disabled” is generally rejected and should be replaced, for example, by designations “disabled people” or, even better, “people with disabilities”.
...
When creating assistive technology for disabled people, however, rehabilitation technology must make use of precisely these abilities and strengths in order to be able to contribute to compensating for weaknesses and deficiencies.
